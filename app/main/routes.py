...
from .forms import (
    EditProfileForm, EmptyForm, PostForm, SearchForm
)
...
def index():
    ...
    return render_template("main/index.html", posts=posts.items, form=form,
...
def user_detail(username):
    ...
    next_url = url_for(
        'main.user_detail', username=user.username, page=posts.next_num
    ) if posts.has_next else None
    prev_url = url_for(
        'main.user_detail', username=user.username, page=posts.prev_num
...
def explore():
    ...
    next_url = url_for("main.index", page=posts.next_num) if posts.has_next else None
    prev_url = url_for("main.index", page=posts.prev_num) if posts.has_prev else None
    return render_template("main/index.html", title=_("All posts"), posts=posts.items,
                           next_url=next_url, prev_url=prev_url)
